...
func DefaultKeymap() Keymap {
	return Keymap{
		Global: []string{
			...
			"details: j/k or ↑/↓ select item, Enter/Space on description opens full view, Ctrl+X ext edit, Esc close",
			"description view: j/k or ↑/↓ scroll, Ctrl+X ext edit, Esc close",
			"/: focus search",
			"f: focus search",
